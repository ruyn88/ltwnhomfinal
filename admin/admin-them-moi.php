...
<html lang="en">
  <head>
    ...
    <title>Sun Phone | Trang Thêm người dùng</title>
            ...
            <div class="right_col" role="main">
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <br><br><br>
                  <form method="post" action="admin-them-moi-thuc-hien.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên người dùng<span class="required">*</span></label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtTen" type="text" class="form-control">
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtsdt" type="text" class="form-control">
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtPassword" type="text" class="form-control">
                    </div>
                  </div>
                  <br><br><br>
