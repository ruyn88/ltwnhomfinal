...
<html lang="en">
  <head>
    ...
    <title> Sun Phone | Trang Sửa sự kiện</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            // Bước 1: Kết nối đến CSDL 
                  ...
                  //Bước 3: Hiển thị các dữ liệu trong bảng tbl_su_kien ra đây
                  $sql = "
                    SELECT * 
                    FROM banner
                    WHERE ma_banner = ".$id;
            ...
            <div class="right_col" role="main">
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <h1>SỬA SỰ KIỆN</h1>
                  <div>
                  <form method="post" action="su-kien-sua-thuc-hien.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên sự kiện<span class="required">*</span></label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtTieuDe" type="text" class="form-control" value="<?php echo $row["ten_banner"];?>">
                    </div>
                  </div>
                  <br><br><br>
                  ...
                  <div class="form-group" style="float: right;">
                   <input type="hidden" name="txtID" value='<?php echo $row["ma_banner"];?>'>
