                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div><!-- 
                   ...
                   <table class="table table-bordered">
                      ...
                      $sql = "
                        SELECT * FROM orders a join khachhang b on a.khach_id =b.khach_id
                      ...
                      ;?>
                        <tr>
                          ...
                          <td style="text-align: center;"><?php echo $row["order_id"];?></td>
                           ...
                           <td style="text-align: center;"><a href="order_print.php?id=<?php echo $row['order_id']?>" target="_blank">In</a></td>
                          <td style="text-align: center;"><?php echo $row["ngaythang"];?></td>
                        </tr>
                      <?php
                      }
                      ;?>
